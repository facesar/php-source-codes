<section>
    ...
    <section class="bg-light text-center">
        <div class="w-100 pt-5 m-auto" style="width:100%;
                                            padding-right:15px;
                                            padding-left:15px;
                                            margin-right:auto;
                                            margin-left:auto;">
            <h1>FACULTIES</h1>
            <p>ICBS serves the national and international community throug a broad spectrum of undergraduate</p>
            <div class="row pt-3 pb-3">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-10 m-auto">
                    <div class="card card-margin">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Faculty of Bussiness Administration</h5>
                        </div>
                    </div>
                </div>
            </div>
